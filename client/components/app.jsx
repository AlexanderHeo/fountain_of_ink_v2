	    ...
	    <Router basename='/' >
	      <Container>
	        ...
	        <Switch>
	          ...
	          <Route path='/fountainpens/:category' render={props => <ProductDisplay {...props}/>} />
	          <Route exact path='/fountainpens/all' render={props => <ProductDisplay {...props}/>} />
	          <Route path='/inks/:category' render={props => <ProductDisplay {...props}/>} />
	          <Route path='/paper/:category' render={props => <ProductDisplay {...props}/>} />
	          <Route path='/accessories/:category' render={props => <ProductDisplay {...props}/>} />
	        </Switch>
